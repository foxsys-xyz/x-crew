                ...
                <form id="finalize-application" action="{{ route('apply.finalize') }}" method="post">
                    ...
                    <div class="mt-4 lg:flex w-full gap-2">
                        <div class="w-full lg:w-full mt-1 lg:mt-0">
                            ...
                            <input name="fname" class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500 {{ $applicant->fname == null ? '' : 'cursor-not-allowed opacity-75' }}" placeholder="John" @if ($applicant->fname != null) value="{{ $applicant->fname }}" disabled @endif />
                        </div>
                        <div class="w-full lg:w-full mt-1 lg:mt-0">
                            ...
                            <input name="lname" class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500 {{ $applicant->lname == null ? '' : 'cursor-not-allowed opacity-75' }}" placeholder="Doe" @if ($applicant->lname != null) value="{{ $applicant->lname }}" disabled @endif />
                        </div>
                    </div>
                    ...
                    <div class="mt-2 lg:flex w-full gap-2">
                        <div class="w-full lg:w-full mt-1 lg:mt-0">
                            ...
                            <input name="dob" class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500" placeholder="yyyy-mm-dd" value="{{ $applicant->dob }}" />
                        </div>
                        <div class="w-full lg:w-full mt-1 lg:mt-0">
                            ...
                            <select name="country" class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500 {{ $applicant->country == null ? '' : 'cursor-not-allowed opacity-75' }}" @if ($applicant->country != null) disabled @endif>
