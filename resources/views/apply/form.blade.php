        ...
        <div class="container h-full mx-auto flex justify-center items-center">
            <div class="p-12 lg:p-0 w-full lg:w-2/5">
                ...
                <div class="lg:flex items-center mt-4">
                    ...
                    </svg>howdy, continue application
                </div>
                ...
                <div class="mt-4 lg:flex w-full gap-2">
                    <div class="w-full lg:w-full mt-1 lg:mt-0">
                        <span class="text-xs lg:flex items-center">
                            ...
                            @else
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-checks inline-block w-4 mr-3" viewBox="0 0 24 24" stroke-width="1.5" stroke="#667eea" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <input class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500 {{ $applicant->fname == null ? '' : 'cursor-not-allowed opacity-75' }}" placeholder="John" @if ($applicant->fname != null) value="{{ $applicant->fname }}" disabled @endif />
                    </div>
                    <div class="w-full lg:w-full mt-1 lg:mt-0">
                        <span class="text-xs lg:flex items-center">
                        ...
                        <input class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500 {{ $applicant->lname == null ? '' : 'cursor-not-allowed opacity-75' }}" placeholder="Doe" @if ($applicant->lname != null) value="{{ $applicant->lname }}" disabled @endif />
                    </div>
                </div>
                ...
                <div class="mt-2 lg:flex w-full gap-2">
                    <div class="w-full lg:w-full mt-1 lg:mt-0">
                        ...
                        <input class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500" placeholder="yyyy-mm-dd" value="{{ $applicant->dob }}" />
                    </div>
                    <div class="w-full lg:w-full mt-1 lg:mt-0">
                        <span class="text-xs lg:flex items-center">
                        ...
                        <select class="w-full lg:w-full mt-2 outline-none px-4 py-2 rounded-full focus:shadow-outline bg-gray-200 transition duration-500 {{ $applicant->country == null ? '' : 'cursor-not-allowed opacity-75' }}" @if ($applicant->country != null) disabled @endif>
