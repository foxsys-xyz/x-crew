                ...
                <div class="mt-4 lg:flex w-full lg:gap-2">
                    <div class="w-full lg:w-full mt-1 lg:mt-0">
                        <form id="apply-manual" action="{{ route('apply.manual') }}" method="post">
                            ...
                            <input type="email" name="email" class="w-full mt-2 outline-none px-4 py-2 rounded-full {{ $errors->has('email') ? 'focus:ring focus:ring-red-500' : 'focus:ring focus:ring-indigo-500' }} bg-gray-800 bg-opacity-60 transition duration-500" placeholder="john@doe.com" />
                        </form>
                    </div>
                </div>
