                        ...
                        <table id="search" class="mt-6 w-full">
                            ...
                            @foreach ($schedules as $schedule)
                                ...
                                <tr class="hover:bg-gray-800 hover:bg-opacity-60 transition duration-150">
                                    ...
                                    <td class="py-2 truncate text-xs">{{ $schedule->flightnum }}</td>
                                    <td class="py-2 truncate text-xs">{{ $schedule->departure }}</td>
                                    <td class="py-2 truncate text-xs">{{ $schedule->arrival }}</td>
                                    <td class="py-2 truncate text-xs">{{ $schedule->type }}</td>
                                    <td class="py-2 truncate text-xs">{{ $schedule->aircraft_icao }}</td>
                                    <td class="py-2 truncate text-xs px-4 rounded-r-xl">
